...
ALARM_PATH := vendor/wings/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/wings/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/wings/prebuilt/common/media/audio/ringtones
