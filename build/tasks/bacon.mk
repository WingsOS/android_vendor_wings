...
bacon: $(DEFAULT_GOAL) $(INTERNAL_OTA_PACKAGE_TARGET)
	...
	echo -e ${CL_BLD}${CL_GRN}"Size:"${CL_RED}" `du -sh $(WINGS_TARGET_PACKAGE) | awk '{print $$1}' `"${CL_RST}
	...
	echo -e ${CL_BLD}${CL_GRN}"Integer Value:"${CL_RED}" `wc -c $(WINGS_TARGET_PACKAGE) | awk '{print $$1}' `"${CL_RST}
